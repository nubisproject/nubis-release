...
declare -a EXCLUDE_REPOSITORIES=(nubis-accounts-nubis nubis-accounts-webops nubis-ha-nat nubis-junkheap nubis-mediawiki nubis-meta nubis-puppet-storage nubis-puppet-nat nubis-puppet-nsm nubis-puppet-mig nubis-puppet-eip nubis-puppet-discovery nubis-puppet-consul_do nubis-puppet-configuration nubis-puppet-envconsul nubis-puppet-consul-replicate nubis-storage nubis-vpc )
...
declare -a RELEASE_REPOSITORIES=( nubis-bastionsshkey nubis-builder nubis-deploy nubis-docs nubisproject.github.io nubis-stacks nubis-terraform )
